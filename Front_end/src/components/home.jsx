...
const Home = () => {
    return (
        <div className="home">
            <div className="top mt-4 row" style={{ justifyContent: 'center' }} >
                <img className=" col-lg-6 col-sm-12 p-0" src="./images/homepage.jpg" alt="" />
                <div className="col-lg-3 col-sm-12  bg-warning  p-5 mb-5 h-50"  >
                    ...
                    <a href="/addPost" className="btn btn-dark text-light btn-outline-danger p-3 mt-3 ">Add Post  <span className="ps-3">   -></span></a>
                    <button className="btn col-lg-2 col-sm-2 bg-light  border  heroBtn fw-bold fs-4 rounded-0 text-secondary" style={{ height: "70px", width: "352px", padding: "20px", marginLeft: "-48px", marginBottom: "-50px", marginTop: "10px" }}>Read more &gt;</button>
                </div>
            </div>
                ...
                <div className="sec2   row ">
                    <div className="inner  col-lg-3 col-sm-12   ">
                        <div className="info my-3 ">
                            <img className="col-lg-8 col-sm-4 w-100" src="./images/burger.jpg" alt="" />
                    ...
                    <div className="sec3 col-lg-3 col-sm-12">
                        ...
                        <div className="info my-3 ">
                            <img className="col-lg-8 col-sm-4 w-100" src="./images/pizza.jpg" alt="" />
                            <p>Dessert -------- March 01, 2018</p>
                            <h4>Tasty & Delicious Foods</h4>
                        </div>
                    </div>
                    <div className="info my-3 col-lg-6 col-sm-12">
                        ...
                        <div className="in" style={{ marginTop: '-100px' }}>
                            <p className="text-dark fw-bold ps-3">Food</p>
